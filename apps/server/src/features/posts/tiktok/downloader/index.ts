...
// https://v16-webapp-prime.tiktok.com/video/tos/no1a/tos-no1a-ve-0068-no/o8vF1iAIyBzz9JClIwEsAXdgIf8sKJCi6gEG4Q/?a=1988&bti=ODszNWYuMDE6&ch=0&cr=3&dr=0&lr=all&cd=0%7C0%7C0%7C&cv=1&br=800&bt=400&cs=2&ds=3&ft=ytpHh9DfxxOusd.~YnTD8lcLVWOuRx_HFKKK4sN5IPNbobz7T&mime_type=video_mp4&qs=14&rc=NWY3NWU1aDdmZ2Y5NTZkM0BpanY5ZW85cnBreTMzbzczNUAxYmItX2EwNTYxX2A0NS82YSMvLi4yMmRjMmtgLS1kMTFzcw%3D%3D&btag=e00090000&expire=1758407010&l=2025091906220600756978FAE907236A0A&ply_type=2&policy=2&signature=a6304e1179517b0346aaecc10ebac9d4&tk=tt_chain_token

export async function downloadTiktok(post: ParsedTiktokPost): Promise<boolean> {
  ...
  for (const file of files) {
    try {
      ...
      if (exist) continue;
      const stream = await getFileStream(file.url, cookie);
      ...
      allDownloaded = false;
      console.error(`\nError downloading: ${post.postId} with url: ${file.url}`);
    }
  }
