import type { BitrateInfo, ItemList } from "@workspace/contracts/tiktok/raw";
import type { ParsedTiktokPost } from "../schemas";

export function mediaParser(post: ItemList): ParsedTiktokPost["media"] {
  const media: ParsedTiktokPost["media"] = [];
