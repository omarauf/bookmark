    ...
    <div className="space-y-8">
      <div className="group grid grid-cols-2 gap-8 md:grid-cols-4 md:gap-12">
        ...
        <div className="relative flex flex-col gap-2 after:absolute after:top-2 after:-right-4 after:bottom-2 after:w-px after:bg-muted/30 md:after:-right-6">
          ...
          <span className="text-4xl text-foreground tracking-tighter md:text-5xl">
            {stats.total}
          </span>
        </div>
        ...
        <div className="relative flex flex-col gap-2 after:absolute after:top-2 after:-right-4 after:bottom-2 after:w-px after:bg-muted/30 md:after:-right-6">
          ...
          <span className="text-4xl text-blue-400 tracking-tighter md:text-5xl">{inFlight}</span>
          <span className="text-[10px] text-blue-400/70 tracking-wider">
        ...
        <div className="flex flex-col gap-2">
          ...
          <span className="text-4xl text-rose-500 tracking-tighter md:text-5xl">
            {stats.failed}
          </span>
          <span className="text-[10px] text-rose-500/70 tracking-wider">FAILED JOBS</span>
        </div>
      </div>
    </div>
  );
