...
export const PlatformTypeArray = ["instagram", "twitter", "tiktok"] as const;
...
export const UserPlatformTypeSchema = z.enum(["instagram-user", "twitter-user", "tiktok-user"]);
...
export const PostPlatformTypeSchema = z.enum(["instagram-post", "twitter-post", "tiktok-post"]);
